...
RSpec.describe ChallengeComment, type: :model do
  describe "validations" do
    describe "one_comment_per_day_per_participant" do
      ...
      let(:story) { participant.challenge_story }

      it "allows first comment of the day" do
        comment = build(:challenge_comment, challenge_participant: participant, challenge_story: story)
      ...
      it "prevents second comment on same day" do
        ...
        second_comment = build(:challenge_comment, challenge_participant: participant, challenge_story: story)
      ...
      it "allows comment on different day" do
        create(:challenge_comment, challenge_participant: participant, challenge_story: story, created_at: 1.day.ago)
        today_comment = build(:challenge_comment, challenge_participant: participant, challenge_story: story)
